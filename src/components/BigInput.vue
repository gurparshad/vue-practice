...
<template>
  <div class="parent">
      ...
      <div class="input-wrapper">
        <span>
          <input
            ...
            placeholder="|€"
            @input="updateWidthAndEuroSignPosition"
            ref="inputRef"
          />
    ...
    <div class="dropdownBro" v-show="dropdownOpen">
      <div v-for="option in options" :key="option.id" class="dropdown-item" @click="selectOption(option)">
        {{ option.label }}
      </div>
    </div>
    ...
    <div class="duration-input-dropdown">
      <div class="input-wrapper">
        <input
          type="number"
          v-model="selectedNumber"
          class="form-control custom-input duration-input"
